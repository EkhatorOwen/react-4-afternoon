  ...
  render() {
    return (
      <div>
       ...
       <Link to="/about"><h3 className="subnav_links">About</h3></Link>
       <Link to="/about/history"><h3 className="subnav_links">History</h3></Link>
       <Link to="/about/contract"><h3 className="subnav_links">Contact</h3></Link>
